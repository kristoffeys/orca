...
export function areWorkspaceLinkedItemsEqual(
  ...
  return (
    ...
    (a.productiveIdentifier ?? null) === (b.productiveIdentifier ?? null) &&
...
export function normalizeWorkspaceLinkedItem(value: unknown): WorkspaceLinkedItem | null {
  ...
  return {
    ...
    ...(typeof raw.jiraIdentifier === 'string' && raw.jiraIdentifier.trim().length > 0
      ...
      : {}),
    ...(typeof raw.productiveIdentifier === 'string' && raw.productiveIdentifier.trim().length > 0
      ? { productiveIdentifier: raw.productiveIdentifier.trim() }
      : {}),
